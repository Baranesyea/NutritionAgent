...
| רוטין | טריגר | פעולה |
|-------|--------|--------|
| Weekly Planner | חמישי 07:00 | תפריט + קניות + מיל פרפ + מייל + יומן |
| Daily Check-in | כל יום 08:00 | בדיקת סטיות + תיקון + מייל יומי |
| Weekly Summary | שישי 18:00 | סיכום שבוע + מייל |
